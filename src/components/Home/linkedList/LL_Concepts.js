...
import LL_Structure from './ll_structure.png';
export default function LL_Concepts() {
  ...
  return (
    <div className='container'>
      ...
      <div className='mian'>
          <h1 style={{fontSize:'30px;'}}>Linked List</h1>
          <div className='info'>
          <p> &emsp;&emsp;&emsp;A linked list is a fundamental data structure in computer science.
             It consists of nodes where each node contains data and a reference (link) to the next
              node in the sequence. This allows for dynamic memory allocation and efficient insertion 
              and deletion operations compared to arrays.<br/></p>
             <h3>Linked List Structure :<br/></h3><p>&emsp;&emsp;&emsp; 1. Linked List can be defined as collection of objects called nodes that are randomly stored in the memory.<br/>
            &emsp;&emsp;&emsp;  2. A node contains two fields i.e. data stored at that particular address and the pointer which contains the address of the next node in the memory.<br/>
            &emsp;&emsp;&emsp;  3. The last node of the list contains pointer to the null.<br/></p>
            <img className="imgll"src={LL_Structure}/><br/>


            <h3>Use of Linked List :<br/></h3>
...
&emsp;&emsp;&emsp;2. Sizing is no longer a problem since we do not need to define its size at the time of declaration. List grows as per the program's demand and limited<br/>&emsp;&emsp;&emsp; to the available memory space.</p>
           ...
           <div className='codeArea'>
                <div className='codeDiv'>
                    <p className='code'>struct node<br/>
                    &#123; <br/>
                                            int data;   <br/>
                                            struct node *next; <br/> 
                                            &#125;; <br/>
                                        struct node *head, *ptr;   <br/>
                                        ptr = (struct node *)malloc(sizeof(struct node *));<br/>  </p>
                </div>
           </div>
           <br/>
